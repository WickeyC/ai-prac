...
class Puzzle:
    def __init__(self):
        self.StartNode=['1','2','3','5','6','8','4','0','7'] #default, h(n) = 8 #state representation
    ...
    #actually no need this function as it is defined in the random module --> random.shuffler()
    def shuffler(self):
    ...
    def heuristic(self,node):
        misplacedTile=0 # hamming distance
...
##----------------------------------------------------------------------------- 
    def steepestAscentHillClimbing(self):
        ...
        if currentNode != goalNode: # goal test
            print ("\n---------", "\nLEVEL ", level, "\n---------")
